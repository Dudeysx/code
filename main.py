...
class Main(tk.Frame):
    ...
    def init_main(self):
        ...
        self.tree.heading('description', text='Наименование товара')
        self.tree.heading('costs', text='Состояние')
        self.tree.heading('total', text='ФИО')
...
class Child(tk.Toplevel):
    ...
    def init_child(self):
        ...
        label_description = tk.Label(self, text='Наименование товара:')
        label_description.place(x=50, y=50)
        label_select = tk.Label(self, text='Состояние:')
        label_select.place(x=50, y=80)
        label_sum = tk.Label(self, text='ФИО:')
        ...
        self.combobox = ttk.Combobox(self, values=[u'В процессе', u'Выполнен'])
